<template>
  <div class="flex flex-grow-0">
    <div class="w-1/2">
      <div class="flex px-2 flex-col justify-center self-stretch h-screen">
        <div class="flex w-80 flex-col items-start m-auto">
          ...
          <input
            ...
            name="email"
            value=""
            class="flex px-2.5 py-3.5 gap-2 self-stretch rounded-lg border border-solid shadow-sm h-10"
          />
          <p
    ...
    <div class="w-1/2 bg-[#E24949] relative overflow-hidden h-screen flex">
      ...
      <div class="px-8 flex flex-col justify-center items-center m-auto">
        <div class="relative">
          <img src="@/assets/images/login/Card.png" alt="logo" />
          <img
            src="@/assets/images/login/Card1.png"
            alt="logo"
            class="absolute top-[140px] right-[-10px]"
          />
        </div>
        <div class="py-16">
          <h1
